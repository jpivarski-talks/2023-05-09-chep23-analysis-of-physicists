...
\vspace{0.5 cm}
\begin{uncoverenv}<3->
We weren't first to have this idea: see Chris Ostrouchov's \textcolor{blue}{\href{https://labs.quansight.org/blog/2019/05/python-package-function-usage}{Measuring API Usage}} (2019).
