...
\small
\uncover<3->{Conclusion is the same: ROOT-C++ usage is flat while ROOT-Python and especially NumPy, Matplotlib, Pandas are increasing. Uproot usage $\sim$ TensorFlow.}
...
\begin{uncoverenv}<3->
\vspace{-4.6 cm}
\mbox{ } \hfill \fcolorbox{black}{white}{\begin{minipage}{0.6\linewidth}
Among users identified by ROOT interactions, Python use has always been high (since 2017).

\vspace{0.2 cm}
Might be including too many non-particle physicists.
\end{minipage}} \hfill \mbox{ }
\vspace{4.6 cm}
\end{uncoverenv}
\end{frame}
